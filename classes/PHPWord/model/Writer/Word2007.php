	...
	public function save($pFilename = null) {
		if(!is_null($this->_document)) {
			...
			$objZip->addFromString('word/styles.xml', $this->getWriterPart('styles')->writeStyles($this->_document));
                        ...
                        if ( !file_exists(PHPWORD_BASE_PATH . '/PHPWord/_staticDocParts/numbering.xml') )
                                throw new Exception("Could not open staticDocParts files at ".PHPWORD_BASE_PATH.'/PHPWord/_staticDocParts/numbering.xml');
            // Write static files
